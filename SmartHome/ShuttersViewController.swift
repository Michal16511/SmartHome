...
class ShuttersViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, ShutterCellDelegate {
    ...
    private var cells: [ShuttersTableViewCell] = []
...
//            tableView.reloadData()
    ...
    override func viewDidLoad() {
        ...
        cells.append(ShuttersTableViewCell(shutter: Shutter(name: "Salon"), delegate: self))
